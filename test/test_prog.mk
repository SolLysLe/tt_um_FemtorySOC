...
PROG_FILE ?= $(PROG).hex
SRC_DIR = $(PWD)/../src
PROJECT_SOURCES = project.v femto_quark_bi.v mem_ctrl.v qspi_ctrl.v rf_top.v latch_reg.v peri/*/*.v
...
VERILOG_SOURCES += $(PWD)/gate_level_netlist.v $(SRC_DIR)/rf_top.v
